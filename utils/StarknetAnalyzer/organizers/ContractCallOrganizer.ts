...
export class ContractCallOrganizer {
    ...
    private _provider: Provider | RPCProvider | undefined;
    ...
    static async getContractAbi(contractAddress: string, provider: Provider | RPCProvider) {
    ...
    static async _organizeContractAbi(contractAddress: string, provider: Provider | RPCProvider) {
    ...
    async initialize(provider?: Provider | RPCProvider) {
    ...
    async callViewFn(entrypoint: string, calldata?: BigNumberish[], provider?: Provider | RPCProvider) {
        const _provider = provider ? provider : this.provider;
        if(!_provider) {
